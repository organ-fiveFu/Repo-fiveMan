package com.nurse.healthy.model.vo.trialassessment;
...
@Data
@ApiModel(value = "试用期评估信息查询出参")
public class TrialAssessmentQueryVO {
    ...
    private String lifeEvaluateTime;
    ...
    private String cognitiveEvaluateTime;
    ...
    private String emotionBehaviorEvaluateTime;
    ...
    private String healthEvaluateTime;
    ...
    private String specialRequirementTime;
