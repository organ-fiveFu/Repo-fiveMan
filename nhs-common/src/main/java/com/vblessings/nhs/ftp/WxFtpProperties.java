 ...
 */
@Configuration
@ConfigurationProperties(prefix = WxFtpProperties.WX_FTP_PREFIX)
public class WxFtpProperties {

    public static final String WX_FTP_PREFIX = "wxftp";
    /**
     * host ip
     */
    private String host;
     ...
     * 文件允许类型,默认 JPG
     */
    private List<String> allowType = Collections.singletonList("JPG");
    /**
     * 文件限制大小 单位字节 默认 5M
     */
