...
public class WxFtpUtils {
    ...
    private static WxFtpProperties wxFtpProperties;
    ...
    private static FTPClient getClient() {
        if (Objects.isNull(wxFtpProperties)) {
            wxFtpProperties = SpringUtil.getBean(WxFtpProperties.class);
        }
        FTPClient ftpClient = new FTPClient();
        try {
            ftpClient.connect(wxFtpProperties.getHost(), wxFtpProperties.getPort());
            ftpClient.login(wxFtpProperties.getUser(), wxFtpProperties.getPassword());
    ...
    private static boolean recurDictionary(FTPClient ftpClient, Boolean make) throws IOException {
        String addPath = wxFtpProperties.getWorkspace();
    ...
    public static String getAccessPath() {
        ...
        return wxFtpProperties.getAccessPath();
    }
    ...
    public static String getWorkspace() {
        ...
        return wxFtpProperties.getWorkspace();
    }
}
